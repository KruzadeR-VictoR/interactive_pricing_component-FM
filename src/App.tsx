      ...
      <div className={style.card}>
        <div className={style.top_section}>
          ...
          <div className={style.slider}>
            <div className="progress bg-SoftCyan"></div>
            <div className="slider_icon bg-StrongCyan">
              <img src={slider} alt="slider" className="icon" />
            </div>
          </div>
          ...
          <div className={style.Billing_type}>
            ...
            <div className={isActive ? style.toggle : style.toggleActive} onClick={handleToggle}>
